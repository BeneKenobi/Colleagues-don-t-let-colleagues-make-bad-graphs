...
#| fig-cap: "Bar plot for multi-factor data [@Sheesley]"
#| warning: false
sheesleyData <- read.csv("sheesley.csv") %>% 
  mutate(Weld = as.factor(Weld),
...
#| fig-cap: "Multi-factorial data as boxplot facet"
#| warning: false
...
#| fig-cap: "Alternatives to bar plots: Lollipot Plot and Treemap"
#| warning: false
